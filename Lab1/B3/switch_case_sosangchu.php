...
<head>
    ...
    <title>Trade số thành chữ</title>
</head>
<?php
$so = "";
$chu = "";
    ...
    if (is_numeric($_POST["so"])) {
        switch ($so) {
            ...
            case 9:
                ...
                break;
            default:
                $chu = "Không hợp lệ. Vui lòng nhập số từ 0 đến 9";
                break;
        }
    }
}
...
<body>
    <form action="switch_case_sosangchu.php" method="POST">
            ...
            <tr>
                <td width="177">
                    <p>
                        ...
                        <input type="text" name="so" id="textfield" value="<?php echo htmlspecialchars($so); ?>" />
                    </p>
                </td>
